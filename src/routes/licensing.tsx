...
export const Route = createFileRoute("/licensing")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Detailed licensing terms for prompts, packs, and creative outputs from Osman Visuals.",
      },
      ...
      <div className="mt-10 border-t hairline pt-10 space-y-10 text-[15px] md:text-base leading-relaxed">
        ...
        <div className="space-y-4">
          ...
          <p>
            ...
            By downloading or purchasing any resource from Osman Visuals, you agree to the terms below.
          </p>
        </div>
        ...
        <section>
          ...
          <p className="mb-4">
            ...
            carefully crafted prompts, educational resources, and creative workflows. When you purchase 
            a product, you are purchasing a license to use the content, not ownership of the content itself.
          </p>
        ...
        <section>
          ...
          <p className="mb-2">Every purchase includes a Personal License, unless another license is explicitly stated. With a Personal License, you may:</p>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 mb-4 space-y-1.5 marker:text-gold/50">
            ...
            <li>Sell products that contain your original AI generated artwork, provided the final work is your own creative output.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 mb-4 space-y-1.5 marker:text-gold/50">
            ...
            <li>Give purchased files to friends, clients, or team members without additional licenses.</li>
        ...
        <section>
          ...
          <p>
            If multiple people inside a company need access to the same product, each user should have 
            their own license unless a Team or Enterprise License is offered. One purchase is intended for one user only.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Our prompts are designed to produce professional quality AI images. However, AI platforms 
            continuously evolve. Because of differences between AI models, updates, settings, and 
            reference images, identical results cannot be guaranteed. Your creative decisions remain 
            an important part of the final output.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-2">Purchasing a product does not transfer ownership. Osman Visuals retains full ownership of:</p>
          ...
          <p className="font-medium text-bone mt-2">Only the usage rights described in this agreement are granted.</p>
        </section>

        {/* Free Resources */}
        <section>
          <h2 className="font-display text-2xl text-bone mb-4">Free Resources</h2>
          <p className="mb-2">Free downloads remain protected by copyright. You may use them according to their stated license, but you may not:</p>
          <ul className="list-disc pl-5 mb-4 space-y-1.5 marker:text-gold/50">
        ...
        <section>
          ...
          <p className="mb-2">If we determine that our products have been redistributed, copied, resold, or used in violation of this license, we reserve the right to:</p>
          <ul className="list-disc pl-5 mb-4 space-y-1.5 marker:text-gold/50">
