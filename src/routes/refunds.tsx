      ...
      <div className="mt-10 border-t hairline pt-10 space-y-10 text-[15px] md:text-base leading-relaxed">
        ...
        <div className="space-y-4">
          ...
          <p>
            ...
            protect your information when you visit our website, browse our gallery, access The Vault,
            purchase digital products, or use any services provided by Osman Visuals.
          </p>
        ...
        <section>
          ...
          <p className="mb-6 italic text-bone/60">We never ask for unnecessary personal information.</p>
        ...
        <section>
          ...
          <p>Purchases provide access only to the licensed digital files. No physical products are shipped.</p>
        </section>
        ...
        <section>
          ...
          <p>
            Payments are processed through trusted third party payment providers. We do not store your 
            complete credit card or debit card information on our servers. Please refer to the privacy 
            policies of the payment provider used during checkout.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-2">
            We may use analytics services to understand how visitors use our website. Collected data may include:
          </p>
          <ul className="list-disc pl-5 mb-4 space-y-1.5 marker:text-gold/50">
            <li>Popular pages</li>
        ...
        <section>
          ...
          <p>
            ...
            Please notify us immediately if you believe your account has been accessed without permission.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-2 font-medium text-bone">Purchasing a product grants a personal license to use the purchased material.</p>
          ...
          <ul className="list-disc pl-5 mb-4 space-y-1.5 marker:text-gold/50">
            ...
            <li>Include our products inside another commercial prompt library without written permission</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            Many images displayed throughout Osman Visuals are created using advanced AI image generation 
            models together with original prompt engineering, creative direction, editing, and artistic workflows. 
            These images are presented for educational, portfolio, and demonstration purposes.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-2">Our website may include services provided by trusted third parties such as:</p>
          <ul className="list-disc pl-5 mb-4 space-y-1.5 marker:text-gold/50">
        ...
        <section>
          ...
          <p>
            ...
            practices or content of websites operated by third parties.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We implement reasonable technical and organizational measures to help protect your information 
            from unauthorized access, alteration, disclosure, or destruction. While we strive to protect 
            your data, no method of internet transmission or electronic storage is completely secure.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Osman Visuals is not intended for children under the age of 13. We do not knowingly collect 
            personal information from children. If we become aware that information from a child has been 
            collected, we will remove it as soon as reasonably possible.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We may update this Privacy Policy from time to time. Changes become effective immediately 
            after being published on this page. The "Last Updated" date will always reflect the latest revision.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-6">
            If you have any questions about this Privacy Policy, your personal data, or how your information 
